            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="collapse list-unstyled" id="dashboard">
                     ...
                     <li><a href="{{url('admin-dashboard')}}">><i class="fa fa-clock-o orange_color"></i> <span>Dashboard</span></a></li>
                     <li><a href="{{url('show-product')}}"><i class="fa fa-clock-o orange_color"></i> <span>Products</span></a></li>
                     <li><a href="{{url('create-product')}}"><i class="fa fa-clock-o orange_color"></i> <span>Create - Products</span></a></li>
